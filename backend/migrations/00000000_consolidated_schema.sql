-- 00000000_consolidated_schema.sql
-- Consolidated baseline schema for fresh deployments.
-- Generated from production DB state on 2026-05-15.
-- Applied on fresh databases; skipped on existing databases via schema_migrations tracking.
-- DO NOT edit this file to add new features — create a new dated migration instead.
...
-- search_path left as session default; all identifiers below are fully qualified.
