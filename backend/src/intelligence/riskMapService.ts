...
export async function rebuildStopRiskSnapshot(pool: Pool): Promise<number> {
    ...
    try {
        ...
        //   - The generic 'safety_concern_present' umbrella was retired
        //     (canonical state layer §1, 2026-05-25). Hazard signal is now the
        //     OR over the 8 specific safety *_present types. 'infrastructure_issue_present'
        //     still exists as the infra umbrella but is a candidate for the same
        //     retirement under the same principle.
