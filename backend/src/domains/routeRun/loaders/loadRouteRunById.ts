  ...
  `;
    ...
    return {
        ...
        stops: result.rows.map((r: any) => ({
            ...
            // ISSUE-061: agency-specific export fields live in source_attributes;
            // payload keys unchanged for API compatibility.
            trf_district_code: r.source_attributes?.trf_district_code ?? null,
            bay_code: r.source_attributes?.bay_code ?? null,
            num_shelters: r.source_attributes?.num_shelters ?? null,
